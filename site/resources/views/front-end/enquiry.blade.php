    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumbs">
          <h2 class="breadcrumbs-title">Enquiry</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="contact-messge grey-bg">
            ...
            <div class="leave-review">
              ...
              {{Form::open(["url"=>"contact-us","method"=>"post","id"=>"contact-form"])}}
                ...
                {{Form::text('company','',["placeholder"=>"Organization"])}}
                <span>{{$errors->first('company')}}</span>

                {{Form::text('consultancy_on','',["placeholder"=>"Consultancy On"])}}
                <span>{{$errors->first('consultancy_on')}}</span>
                
                {{Form::textarea('message','',["placeholder"=>"Your Query"])}}
        ...
        <div class="col-md-5 col-12">
          <!-- get-in-toch -->
          <div class="get-in-toch pl-5">
            <div class="section-title mb-30">
              <h3>Quick Contact</b></h3>
            </div>
